...
class KabelVerlegungsTool:
    ...
    def run(self):
        ...
        if self.first_start:
            ...
            # Kabeltypen aus der Datenbank füllen (mit Filter)
            ...
            # Verknüpfe den Cancel-Button, um das Fenster zu schließen
    ...
    def populate_kabel_typen(self):
        """Holt die Kabeltypen aus der Datenbank und füllt die ComboBox (mit Filter für Streckenkabel)."""
        ...
        try:
            ...
            # Füge den Filter hinzu, um nur Kabeltypen mit dem Wert "Streckenkabel" zu laden
    ...
    def daten_importieren(self):
        ...
        try:
            ...
            self.iface.messageBar().pushMessage("Erfolg", "Daten wurden erfolgreich importiert.", level=Qgis.Success)
